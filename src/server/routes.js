...
/* Imports de Marina */
const Marina = require(path.resolve(__dirname, "../routes/marina/MarinaQuotations"));
...
const MarinaQuotationTimelineTypes = require(path.resolve(__dirname, "../routes/marina/MarinaQuotationTimelineTypes"));
...
const SlipTypes = require(path.resolve(__dirname, "../routes/marina/SlipTypes"));
/* Imports de Boats */
...
const BoatElectricity = require(path.resolve(__dirname, "../routes/boats/BoatElectricity"));
...
const Responsible = require(path.resolve(__dirname, "../routes/boats/Responsible"));
...
module.exports = (app, router, newError, Query, validate, mysqlConnection, multer, dropbox) => {
	const instances = [ app, router, newError, Query, validate, mysqlConnection, multer, dropbox ];
