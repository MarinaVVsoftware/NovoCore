// Routes
const Electronic_Wallet_Historic = require("../../controllers/electronicWallet/Electronic_Wallet_Historic");
...
module.exports = (app, router, mysqlConnection) => {
	router.get("/api/Electronic_Wallet_Historic/Read", Electronic_Wallet_Historic.Read(mysqlConnection));
	router.delete(
