// Routes
const Electronic_Wallet = require("../../controllers/electronicWallet/Electronic_Wallet");
...
module.exports = (app, router, mysqlConnection) => {
	router.get("/api/Electronic_Wallet/Read", Electronic_Wallet.Read(mysqlConnection));
	router.delete(
